...
function FloatingClip({ style, delay, score }) {
  return (
    ...
    >
      <div className="w-8 h-10 rounded-md bg-gradient-to-b from-accent/30 to-accent2/20 flex items-center justify-center text-[10px]">
        🎬
      </div>
      <div>
        <p className="text-[9px] text-white/35 leading-none mb-0.5">
          Viral score
        </p>
    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(108,92,231,0.09) 0%, transparent 70%)",
          }}
        />
        <div
      ...
      <div className="w-full max-w-md relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-[11px] font-medium text-white/40 uppercase tracking-widest">
                  Password
                </label>
                {isLogin && (
                  <button
            ...
            <div className="mt-5 bg-accent2/5 border border-accent2/15 rounded-xl px-4 py-3 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-white/35 font-light">
                  5 AI clips/month · Auto captions · All imports
                </p>
              </div>
            </div>
          )}
        ...
        <p className="text-center text-[11px] text-white/20 mt-6 font-light">
          ...
          <Link
            to="/"
            className="text-white/35 hover:text-white/60 no-underline transition-colors"
          >
            Terms
          </Link>{" "}
          and{" "}
